...
public class RecentChatAdapter extends RecyclerView.Adapter<RecentChatAdapter.MyViewHolder> implements Filterable {
    ...
    public RecentChatAdapter(Context activity, List<RecentModel> result) {
    ...
    @Override
    public RecentChatAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recentchat_adapter, parent, false);
        return new RecentChatAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final RecentChatAdapter.MyViewHolder holder, final int position) {
